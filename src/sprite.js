...
function getTexture(){
    ...
    var texture2=new THREE.TextureLoader().load("./src/assets/1.png");
    var texture3=new THREE.TextureLoader().load("./src/assets/1.png");
    var texture4=new THREE.TextureLoader().load("./src/assets/1.png");
